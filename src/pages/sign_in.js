...
function Sign_in() {
    ...
    const handlePageSwitch = () => {
      // Use navigate to switch to another page
  ...
  return (
   ...
   <div className='flex gap-4 justify-between '>
    <input
     ...
     <div >
     <select
            className=" w-[160px] h-20 block bg-slate-200 w-full rounded-[10px] py-2 px-3 text-gray-700 leading-tight e"
            id="gender"
            value={sexe}
  ...
  <input
     ...
     />
      ...
      <button onClick={handleSubmit}
       className="w-[264px] h-[65px] mb-14  bg-customBlue rounded-tl-[10px] rounded-bl-[10px] rounded-br-[10px] text-white justify-center items-center gap-2 inline-flex">
      Continuer
     </button>
