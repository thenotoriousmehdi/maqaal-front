    ...
    if (!name) {
      ...
      if (!email) {
        ...
        if (!emailRegex.test(email)) {
          ...
          setErrorEmail("");
          console.log("Data to pass:", { name, email, dateNaissance, sexe });
          setIsValid(true);
      ...
      <div className="flexbox flex-col w-full xl:w-1/2 h-screen flex items-center justify-center  ">
        ...
        <div className="flex flex-col w-full xl:w-[640px] xl:h-[901px] h-full items-center justify-evenly bg-white  md:shadow-2xl  rounded-2xl ">
          ...
          <div className="flex flex-col justify-evenly items-center gap-5 ">
            <div class="xl:w-[277px] w-full h-[29px] text-center text-slate-700 text-3xl font-extrabold font-['Raleway']">
              Créer un compte{" "}
            </div>
            <div class="xl:w-[449px] w-full h-[61px]  text-center text-black xl:text-[15px] text-[14px] font-medium font-['Raleway']">
