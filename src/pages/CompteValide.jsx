      ...
      <div className=" flexbox flex-col  w-full xl:w-1/2 h-screen flex items-center justify-center  ">
        ...
        <div className="flex flex-col w-full xl:w-[640px] xl:h-[901px] h-full items-center justify-evenly bg-white  md:shadow-2xl  rounded-2xl ">
          ...
          <div className="flex flex-col items-center  mb-8 gap-8">
            <div class="xl:w-[277px] w-full text-center text-slate-700 xl:text-5xl text-3xl font-bold font-['Raleway']">
              Félicitations!
            </div>
            <div class="wl:w-[869.14px] w-full text-center text-slate-700 xl:text-3xl text-xl font-medium font-['Raleway'] leading-[45px]">
              Félicitations, vous avez terminer la <br />
              création de votre compte avec succès.{" "}
            </div>
          </div>
          <Link to={"/"}>
            <button
              className="bg-primary sm:w-[528px] h-[65px] w-2/3 font-['SF Pro'] text-white font-normal  rounded-tl-full rounded-bl-full rounded-tr-none rounded-br-full
       "
            >
              Vers l'acceuil
            </button>
