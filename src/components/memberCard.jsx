...
const memberCard = ({props}) => {
  ...
  return (
    ...
    }} className="mx-20 h-[560px]  z-0  my-5  font-title text-primary   border  border-primary 
     w-96 text-2xl rounded-tl-3xl relative rounded rounded-b-3xl flex flex-col items-center    gap-8  card ">     
