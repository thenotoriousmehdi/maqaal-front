...
const footer = () => {
  return (
    <div className=' bg-primary flex flex-wrap-reverse  justify-center sm:justify-between  h-44 sm:px-5'> 
        ...
        <a href="https://www.facebook.com" className=' m-4'>
        <FaFacebook  className=' text-white md:w-16 md:h-16  h-  h-9 w-9'/>
          </a>
         <a href="https://www.twitter.com" className=' m-4' >
         <FaXTwitter className=' text-white md:w-16 md:h-16  h-9 w-9' />
         </a>
           <a href="https://www.github.com"  className=' m-4'>
