  ...
  return (
    <>
      <div className="  sticky   bg-white  z-50  top-0 font-title   font-semibold text-2xl  flex  justify-between shadow-lg items-center  h-32 ">
        <Link to="/">
          {" "}
          <img src={Logonav} alt="logo" className=" ml-9 lg:ml-12" />{" "}
        </Link>

        <div className="xl:flex xl:text-primary flex-wrap  hidden  xl:block gap-14 ">
          <NavLink
            to="/Apropos"
            className={({ isActive }) => (isActive ? " text-rosee" : "")}
          >
            <p>A propos</p>{" "}
          </NavLink>
           ...
           {token ? (
            ...
            <>
              ...
              <Link to="/SignIn">
                <button
                  type="submit"
                  className="hidden md:block items-center m-3 px-8 lg:px-14 pb-2 lg:py-7 bg-primary rounded-tl-3xl rounded-b-3xl lg:font-medium h-16 lg:h-20 text-white hover:bg-red-400 lg:text-2xl text-lg transform transition-transform duration-200 ease-in-out hover:scale-110 focus:outline-none focus:ring-2 focus:ring-rose-700 focus:ring-opacity-75"
                >
                  S'inscrire
                </button>
              </Link>
      ...
      {isOpen && (
        <div className=" flex-col xl:hidden gap-11 z-50  bg-white font-title   font-semibold text-2xl  flex  py-12  shadow-lg items-center">
          ...
          <div className="flex  md:hidden  flex-wrap-reverse items-center gap-12 justify-center w-full px-8">
            <button
              className="  px-8  text-xl   rounded-tl-3xl rounded-b-3xl  h-16  border-primary  border  
            transform transition-transform duration-200 ease-in-out hover:scale-110 focus:border-rosee focus:outline-none focus:ring-1 focus:ring-rosee focus:ring-opacity-75 "
            >
              se connecter{" "}
            </button>
            <button
              className=" px-8    bg-primary rounded-tl-3xl rounded-b-3xl    h-16  text-white  hover:bg-red-400
           text-xl transform transition-transform duration-200 ease-in-out hover:scale-110 focus:outline-none focus:ring-2 focus:border-rosee focus:ring-opacity-75 "
            >
              s'inscrire
            </button>
          </div>
